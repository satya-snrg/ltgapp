...
<head>
    ...
    <script src="https://kit.fontawesome.com/9e35f21b83.js" crossorigin="anonymous"></script>
...
@include('v2.layouts.snippets.sidebar.admin-sidebar')
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- top bar-->
            @include('v2.layouts.snippets.topbar')
